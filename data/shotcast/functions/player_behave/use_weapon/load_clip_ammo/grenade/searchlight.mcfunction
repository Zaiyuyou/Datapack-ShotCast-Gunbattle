...
execute as @s[nbt={SelectedItem:{id:"minecraft:crossbow",tag:{Damage:0,Tags:["zyy.shotcast.weapon.thrower"]}}}] run item modify entity @s weapon.mainhand shotcast:load_clip_ammo/grenade/searchlight
